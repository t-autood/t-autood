...
4. tar xzvf benchmark_datasets.tar.gz    - after this command, the "benchmark_datasets" sub-folder is created. This folder includes 44 data sets - note that one file is removed since its size exceeds 25MB - the limit of github.com. Each data file contains pre-computed outlier scores by 20 pipelines in "pipelines" sub-folder.
